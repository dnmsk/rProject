...
namespace Project_B.CodeServerSide.Entity {
    ...
    /// </summary>
    [Serializable]
    [DBTable("SiteInternalLink")]
    [TargetDb(TargetDB.MASTER)]
    public sealed class SiteInternalLink : AbstractEntityTemplateKey<SiteInternalLink, short> {
        ...
        /// 
        /// </summary>
        public SiteInternalLink() {
        }

        /// <summary>
        /// 
        /// </summary>
        public SiteInternalLink(Hashtable ht) : base(ht) { }
        /// <summary>
        /// 
        /// </summary>
        public short ID {
