...
namespace CommonUtils.Code {
    public class WebRequestHelper : IDisposable, ICloneable {
        ...
        private static readonly Dictionary<WebRequestParamType, WebRequestParamBase> _defaultParamsBase = new Dictionary<WebRequestParamType, WebRequestParamBase> {
            ...
            { WebRequestParamType.TimeoutInt, new WebRequestParamInt(10000) },
            { WebRequestParamType.ReadWriteTimeoutInt, new WebRequestParamInt(10000) },
            { WebRequestParamType.MaximumAutomaticRedirectionsInt, new WebRequestParamInt(10) },
